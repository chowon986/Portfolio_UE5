...
#include "PlaceholderItemBase.h"
#include "ItemDataBase.h"
#include "../Character/LvPlayer.h"
#include "../Component/Placeholder.h"

void UPlaceholderItemBase::NativeConstruct()
{
...
void UPlaceholderItemBase::NativeTick(const FGeometry& _geo, float _DeltaTime)
{
	Super::NativeTick(_geo, _DeltaTime);

}

void UPlaceholderItemBase::InitFromData(UObject* _Data)
{
